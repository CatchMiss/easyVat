 ...
 */
package com.moptim.easyvat.zxing.activity;
...
import com.moptim.easyvat.zxing.utils.BeepManager;
import com.moptim.easyvat.zxing.utils.CaptureHandler;
import com.moptim.easyvat.zxing.utils.InactivityTimer;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	public void onCreate(Bundle icicle) {
		...
		SurfaceView scanPreview = findViewById(R.id.capture_preview);
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		...
		try {
			...
			if (captureHandler == null) {
				captureHandler = new CaptureHandler(this, cameraManager, DecodeThread.ALL_MODE);
			}
